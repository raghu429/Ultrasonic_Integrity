...
A = audioread('75_A_1.wav');
B = audioread('75_A_2.wav');
C = audioread('75_A_3.wav');
D = audioread('75_A_4.wav');
E = audioread('75_A_5.wav');
F = audioread('75_A_6.wav');
G = audioread('75_A_7.wav');
H = audioread('75_A_8.wav');
I = audioread('75_A_9.wav');
...
A = audioread('75_B_1.wav');
B = audioread('75_B_2.wav');
C = audioread('75_B_3.wav');
D = audioread('75_B_4.wav');
E = audioread('75_B_5.wav');
F = audioread('75_B_6.wav');
G = audioread('75_B_7.wav');
H = audioread('75_B_8.wav');
I = audioread('75_B_9.wav');
...
MagSpecB = abs(TotalMatrixB);

%% Do for each sensor

A = audioread('75_C_1.wav');
B = audioread('75_C_2.wav');
C = audioread('75_C_3.wav');
D = audioread('75_C_4.wav');
E = audioread('75_C_5.wav');
F = audioread('75_C_6.wav');
G = audioread('75_C_7.wav');
H = audioread('75_C_8.wav');
I = audioread('75_C_9.wav');
...
MagSpecC = abs(TotalMatrixC);

%% Do for each sensor

A = audioread('75_D_1.wav');
B = audioread('75_D_2.wav');
C = audioread('75_D_3.wav');
D = audioread('75_D_4.wav');
E = audioread('75_D_5.wav');
F = audioread('75_D_6.wav');
G = audioread('75_D_7.wav');
H = audioread('75_D_8.wav');
I = audioread('75_D_9.wav');
...
MagSpecD = abs(TotalMatrixD);

%% Do for each sensor

A = audioread('75_E_1.wav');
B = audioread('75_E_2.wav');
C = audioread('75_E_3.wav');
D = audioread('75_E_4.wav');
E = audioread('75_E_5.wav');
F = audioread('75_E_6.wav');
G = audioread('75_E_7.wav');
H = audioread('75_E_8.wav');
I = audioread('75_E_9.wav');
